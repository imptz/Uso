...
//	ConfigDataStructProgram** programs = Config::getSingleton().getConfigData()->getConfigDataStructPrograms();
	...
	{
		pAddress[i] = Config::getSingleton().getPRAddressByNumber(Config::getSingleton().getConfigData()->programs[listProgramIndex[i]].prNumber);
		int x1 = Config::getSingleton().getConfigData()->programs[listProgramIndex[i]].point1.x;
		int x2 = Config::getSingleton().getConfigData()->programs[listProgramIndex[i]].point2.x;
		int y1 = Config::getSingleton().getConfigData()->programs[listProgramIndex[i]].point1.y;
		int y2 = Config::getSingleton().getConfigData()->programs[listProgramIndex[i]].point2.y;

//		ConfigDataStructPRPosition** pr = Config::getSingleton().getConfigData()->getConfigDataStructPRPositions();

		unsigned int index = Config::getSingleton().getPRIndexByAddress(Config::getSingleton().getPRAddressByNumber(Config::getSingleton().getConfigData()->programs[listProgramIndex[i]].prNumber));
...
//	ConfigDataStructProgram** programs = Config::getSingleton().getConfigData()->getConfigDataStructPrograms();
	...
	for (unsigned int i = 0; i < addressPointsCount; i++)
	{
		pChannelInfo[i].address = Config::getSingleton().getPRAddressByNumber(Config::getSingleton().getConfigData()->programs[listProgramIndex[i]].prNumber);
		pChannelInfo[i].point1.x = Config::getSingleton().getConfigData()->programs[listProgramIndex[i]].point1.x;
		pChannelInfo[i].point1.y = Config::getSingleton().getConfigData()->programs[listProgramIndex[i]].point1.y;
		pChannelInfo[i].point2.x = Config::getSingleton().getConfigData()->programs[listProgramIndex[i]].point2.x;
		pChannelInfo[i].point2.y = Config::getSingleton().getConfigData()->programs[listProgramIndex[i]].point2.y;
		pChannelInfo[i].mode = Config::getSingleton().getConfigData()->constants.numberFireToAnalize;
...
//	ConfigDataStructPRPosition** pr = Config::getSingleton().getConfigData()->getConfigDataStructPRPositions();
	...
	for (unsigned int preFireIndex = 0; preFireIndex < count; preFireIndex++)
	{
		unsigned int index = Config::getSingleton().getPRIndexByAddress(preFires[preFireIndex].channel);
		preFires[preFireIndex].pivotPoint = Config::getSingleton().getConfigData()->prPositions[index].position;
		...
		Point2<float> sensorAngle = Config::getSingleton().getConfigData()->prPositions[index].orientation;
