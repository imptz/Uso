...
//	ConfigDataStructIOBk16** outputs = Config::getSingleton().getConfigData()->getConfigDataStructIOBk16();
	for (unsigned int i = 0; i < Config::getSingleton().getConfigData()->ioBk_count; i++)
		if (Config::getSingleton().getConfigData()->ioBk[i].outputFunctionGroup == ConfigData_ioBk::OUTPUT_FUNCTION_GROUP_FIRE_ALARM)
		{
			setOutput((Config::getSingleton().getConfigData()->ioBk[i].bkAddress - 1) * 8 + Config::getSingleton().getConfigData()->ioBk[i].numberOnDevice - 1, IIODevice::OUTPUT_STATE_ON);
...
//	ConfigDataStructIOBk16** outputs = Config::getSingleton().getConfigData()->getConfigDataStructIOBk16();
	for (unsigned int i = 0; i < Config::getSingleton().getConfigData()->ioBk_count; i++)
		if (Config::getSingleton().getConfigData()->ioBk[i].outputFunctionGroup == ConfigData_ioBk::OUTPUT_FUNCTION_GROUP_FIRE_ALARM)
		{
			setOutput((Config::getSingleton().getConfigData()->ioBk[i].bkAddress - 1) * 8 + Config::getSingleton().getConfigData()->ioBk[i].numberOnDevice - 1, IIODevice::OUTPUT_STATE_OFF);
...
//	ConfigDataStructIOBk16** outputs = Config::getSingleton().getConfigData()->getConfigDataStructIOBk16();
	for (unsigned int i = 0; i < Config::getSingleton().getConfigData()->ioBk_count; i++)
		if (Config::getSingleton().getConfigData()->ioBk[i].outputFunctionGroup == ConfigData_ioBk::OUTPUT_FUNCTION_GROUP_HARDWARE)
		{
			setOutput((Config::getSingleton().getConfigData()->ioBk[i].bkAddress - 1) * 8 + Config::getSingleton().getConfigData()->ioBk[i].numberOnDevice - 1, IIODevice::OUTPUT_STATE_ON);
...
//	ConfigDataStructIOBk16** outputs = Config::getSingleton().getConfigData()->getConfigDataStructIOBk16();
	for (unsigned int i = 0; i < Config::getSingleton().getConfigData()->ioBk_count; i++)
		if (Config::getSingleton().getConfigData()->ioBk[i].outputFunctionGroup == ConfigData_ioBk::OUTPUT_FUNCTION_GROUP_PUMPING_STATION)
		{
			setOutput((Config::getSingleton().getConfigData()->ioBk[i].bkAddress - 1) * 8 + Config::getSingleton().getConfigData()->ioBk[i].numberOnDevice - 1, IIODevice::OUTPUT_STATE_ON);
...
//	ConfigDataStructIOBk16** outputs = Config::getSingleton().getConfigData()->getConfigDataStructIOBk16();
	for (unsigned int i = 0; i < Config::getSingleton().getConfigData()->ioBk_count; i++)
		if ((Config::getSingleton().getConfigData()->ioBk[i].outputFunctionGroup == ConfigData_ioBk::OUTPUT_FUNCTION_GROUP_PR_PRESSURE_UP) && (Config::getSingleton().getConfigData()->ioBk[i].prGateNumber == number))
		{
			setOutput((Config::getSingleton().getConfigData()->ioBk[i].bkAddress - 1) * 8 + Config::getSingleton().getConfigData()->ioBk[i].numberOnDevice - 1, IIODevice::OUTPUT_STATE_ON);
...
//	ConfigDataStructIOBk16** outputs = Config::getSingleton().getConfigData()->getConfigDataStructIOBk16();
	for (unsigned int i = 0; i < Config::getSingleton().getConfigData()->ioBk_count; i++)
		if ((Config::getSingleton().getConfigData()->ioBk[i].outputFunctionGroup == ConfigData_ioBk::OUTPUT_FUNCTION_GROUP_GATE_OPEN) && (Config::getSingleton().getConfigData()->ioBk[i].prGateNumber == number))
		{
			setOutput((Config::getSingleton().getConfigData()->ioBk[i].bkAddress - 1) * 8 + Config::getSingleton().getConfigData()->ioBk[i].numberOnDevice - 1, IIODevice::OUTPUT_STATE_ON);
...
//	ConfigDataStructIOBk16** outputs = Config::getSingleton().getConfigData()->getConfigDataStructIOBk16();
	for (unsigned int i = 0; i < Config::getSingleton().getConfigData()->ioBk_count; i++)
		if (Config::getSingleton().getConfigData()->ioBk[i].outputFunctionGroup == ConfigData_ioBk::OUTPUT_FUNCTION_GROUP_SYSTEM_FAULT)
		{
			setOutput((Config::getSingleton().getConfigData()->ioBk[i].bkAddress - 1) * 8 + Config::getSingleton().getConfigData()->ioBk[i].numberOnDevice - 1, IIODevice::OUTPUT_STATE_ON);
...
//	ConfigDataStructIOBk16** outputs = Config::getSingleton().getConfigData()->getConfigDataStructIOBk16();
	for (unsigned int i = 0; i < Config::getSingleton().getConfigData()->ioBk_count; i++)
		if ((Config::getSingleton().getConfigData()->ioBk[i].outputFunctionGroup == ConfigData_ioBk::OUTPUT_FUNCTION_GROUP_GATE_FAULT) && (Config::getSingleton().getConfigData()->ioBk[i].prGateNumber == number))
		{
			setOutput((Config::getSingleton().getConfigData()->ioBk[i].bkAddress - 1) * 8 + Config::getSingleton().getConfigData()->ioBk[i].numberOnDevice - 1, IIODevice::OUTPUT_STATE_ON);
...
//	ConfigDataStructIOBk16** outputs = Config::getSingleton().getConfigData()->getConfigDataStructIOBk16();
	for (unsigned int i = 0; i < Config::getSingleton().getConfigData()->ioBk_count; i++)
		if ((Config::getSingleton().getConfigData()->ioBk[i].outputFunctionGroup == ConfigData_ioBk::OUTPUT_FUNCTION_GROUP_PR_FAULT) && (Config::getSingleton().getConfigData()->ioBk[i].prGateNumber == number))
		{
			setOutput((Config::getSingleton().getConfigData()->ioBk[i].bkAddress - 1) * 8 + Config::getSingleton().getConfigData()->ioBk[i].numberOnDevice - 1, IIODevice::OUTPUT_STATE_ON);
